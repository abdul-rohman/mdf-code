...
function showResult(json) {
	...
	skeleton += '<a title="Close" style="display:block;position:absolute;top:10px;right:12px;line-height:normal;" href="#close" onclick="resultContainer.style.display=\'none\';return false;">[&times;]</a><ol>';
	if (entry === "") {
